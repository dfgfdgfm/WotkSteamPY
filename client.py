...
from steampy.generate_proxy import get_random_proxy
...
class SteamClient:
    ...
    def get_trade_offers(self, merge: bool = True, use_webtoken=True) -> dict:
        params = {
    ...
    def get_all_trade_offers(self):
        ...
        current_proxy = get_random_proxy(self._last_proxy)
        ...
        proxies = {
            ...
            'Cache-Control': 'private,max-age=630',
        ...
        response = self._session.get('https://steamcommunity.com/profiles/{}/tradeoffers/'.format(steam_id), headers=headers, proxies=proxies)
        ...
        for trade_offer in trade_offer_list:
            ...
            if trade_app_id == 730:
                for item in items_class:
                    ...
                    data = self._session.get(url, headers=headers).json()
    ...
    def fetch_trade_partner_id(self, trade_offer_id: str) -> str:
    ...
    def decline_trade_offer(self, trade_offer_id: str) -> dict:
        ...
        session_id = self._session.cookies.get_dict("steamcommunity.com")['sessionid']
        response = self._session.post(url, data={'sessionid': session_id}).json()
        return response
